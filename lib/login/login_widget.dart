...
class _LoginWidgetState extends State<LoginWidget>
  ...
  void initState() {
    ...
    _model.loginNameTextController ??= TextEditingController();
    _model.loginNameFocusNode ??= FocusNode();
                    ...
                    Row(
                      ...
                      children: [
                        ClipRRect(
                          ...
                          child: Image.asset(
                            'assets/images/to-do-app-high-resolution-logo-white-transparent.png',
                            width: 120.0,
                            fit: BoxFit.contain,
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(
                                        ...
                                        child: TextFormField(
                                          controller: _model
                                              .enterPasswordTextController,
                                          focusNode:
                                              _model.enterPasswordFocusNode,
                                          autofocus: false,
                                          textInputAction: TextInputAction.next,
                                          obscureText:
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      SizedBox(
                                        ...
                                        child: TextFormField(
                                          controller:
                                              _model.loginNameTextController,
                                          focusNode: _model.loginNameFocusNode,
                                          onChanged: (_) =>
                                              EasyDebounce.debounce(
                                            '_model.loginNameTextController',
                                            const Duration(milliseconds: 2000),
                                          ...
                                          cursorColor:
                                              FlutterFlowTheme.of(context)
                                                  .primaryText,
                                          validator: _model
                                              .loginNameTextControllerValidator
                                              .asValidator(context),
                                        ),
                                      ),
                                      SizedBox(
                          ...
                          FFButtonWidget(
                            onPressed: () async {
                              ...
                              final user = await authManager.signInWithEmail(
                                context,
                                _model.loginNameTextController.text,
                        ...
                        if (_model.tabBarCurrentIndex == 0)
                          FFButtonWidget(
                            onPressed: () async {
                              ...
                              _model.apiResult87u = await SendEmailCall.call(
                                to: _model.enterEmailTextController.text,
                                subject: 'ToDo App',
                                text: 'Thaank you for Signing up!',
                              );
